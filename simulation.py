...
signalCoods = [(810,570),(530,570),(530,230),(810,230)]
signalTimerCoods = [(810,550),(530,550),(530,210),(810,210)]
...
rotationAngle = 3
mid = {'right': {'x':622, 'y':466}, 'down': {'x':602, 'y':355}, 'left': {'x':755, 'y':348}, 'up': {'x':755, 'y':466}}
...
class Vehicle(pygame.sprite.Sprite):
    ...
    def move(self):
        if(self.direction=='right'):
            ...
            if(self.willTurn==1):
                if(self.lane == 2):
                    if(self.crossed==0 or self.x+self.image.get_rect().width<stopLines[self.direction]+105):
            ...
            if(self.willTurn==1):
                if(self.lane == 2):
                    if(self.crossed==0 or self.y+self.image.get_rect().height<stopLines[self.direction]+110):
            ...
            if(self.willTurn==1):
                if(self.lane == 2):
                    if(self.crossed==0 or self.x>stopLines[self.direction]-120):
